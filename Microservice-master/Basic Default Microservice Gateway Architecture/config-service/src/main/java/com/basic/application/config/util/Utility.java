package com.basic.application.config.util;
...
import com.basic.application.config.constants.ApplicationConstants.ParsedRequestData.RequestParams;
import com.basic.application.config.constants.ApplicationConstants.ParsedRequestData.SubUrlType;
import com.basic.application.config.response.Response;
...
public class Utility {
	...
	public static Response sendFailureResponse(Throwable e) {
		Map<String, Object> data = new java.util.HashMap<>();
		data.put("errorResponse", e);
		return new Response(1000, e.getMessage(), ApplicationConstants.HttpMessage.FAILURE, data);
	}
